          ...
          >
            ...
            {isSearchingSchools ? (
              ...
              <View style={{ flex: 1 }}>
                <FlatList
                  data={defaultSchools}
                  keyExtractor={(item, index) => item.name + index + item.logo}
                  renderItem={({ item }) => (
                    <TouchableOpacity
                      style={[
                        styles.searchOption,
          ...
          >
            ...
            {degreeQuery.trim() &&
              !defaultDegrees.some((degree) =>
                degree.toLowerCase().includes(degreeQuery.trim().toLowerCase())
              ) && (
                <TouchableOpacity
                  style={[
                    styles.searchOption,
                    newDegree === degreeQuery && styles.searchOptionSelected,
                  ]}
                  onPress={() => {
                    setNewDegree(degreeQuery);
                    setDegreeQuery("");
                    setIsDegreeModalVisible(false);
                  }}
                >
                  <View style={styles.degreeItem}>
                    ...
                    <Text
                      style={[
                        ...
                        {
                          color:
                            newDegree === degreeQuery ? "#ffffff" : "#000000",
                        },
                      ]}
                    >
                      {degreeQuery}
            ...
            {fieldQuery &&
              !defaultFields.some((field) =>
                ...
                <TouchableOpacity
                  style={[
                    styles.searchOption,
                    newFieldOfStudy === fieldQuery &&
                      styles.searchOptionSelected,
                  ]}
                  onPress={() => {
                    setNewFieldOfStudy(fieldQuery);
                    setFieldQuery("");
                    setIsFieldModalVisible(false);
                  }}
                >
